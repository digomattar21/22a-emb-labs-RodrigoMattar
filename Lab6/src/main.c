...
// # 1
#define LED_1_ID        ID_PIOA                  // ID do periférico PIOC (controla LED)
...
// # 2
#define LED_2_ID        ID_PIOC                  // ID do periférico PIOC (controla LED)
...
// # 3
#define LED_3_ID        ID_PIOB                  // ID do periférico PIOC (controla LED)
